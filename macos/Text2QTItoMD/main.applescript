on open droppedFiles
	...
	set scriptPath to bundlePath & "Contents/Resources/Scripts/t2qti2md.py"
	...
	repeat with f in droppedFiles -- f is an alias
		...
		set outPath to parentDir & "/" & baseName & ".md"

		-- Build command and merge stderr into stdout (2>&1)
		set cmd to "/usr/bin/env python3 " & scriptPath & " " & quoted form of filePosix & " -o " & quoted form of outPath
